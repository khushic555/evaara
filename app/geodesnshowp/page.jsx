...
// 🟢 Standardized layout with slug IDs for individual details matching
const products = [
  { id: "pyrite-geode-ball", name: "Pyrite Geode ball", price: "₹8999", image: "/3.1.jpg" },
  { id: "rose-quartz-cluster", name: "Rose Quartz Cluster", price: "₹10299", image: "/3.2.jpg" },
  { id: "selenite-geode", name: "Selenite Geode", price: "₹7900", image: "/3.3.JPG" },
  { id: "7-chakras-tree", name: "7 chakras tree", price: "₹1499", image: "/3.4.jpg" },
  { id: "green-aventurine-tree", name: "Green Aventurine tree", price: "₹999", image: "/3.5.jpg" },
];
    ...
    <div className="relative min-h-screen bg-[#fcfaf7] bg-[url('https://www.transparenttextures.com/patterns/notebook.png')]">
      ...
      <div className="relative h-screen overflow-hidden shadow-2xl z-20">
        ...
        <div className="absolute bottom-10 left-10 text-white z-30">
          <h1 className="text-6xl md:text-7xl font-bold tracking-tight">Geodes and Showpieces</h1>
        </div>
      </div>
